...
export default async function NewArrivals() {
  ...
  return (
    <section className="w-full max-w-5xl grid md:grid-cols-1 grid-cols-1 lg:grid-cols-7 flex-row items-center py-16 justify-between">
      <div className="flex left-0 w-full lg:w-auto flex-col gap-6 col-span-1 lg:col-span-3">
