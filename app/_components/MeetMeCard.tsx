  ...
  return (
    <div className="flex-1 w-full md:max-w-[50%] bg-[#B7C5CE] rounded-lg flex flex-row gap-4">
      <Link href={card.Link || "#"} className="rounded-lg relative w-full h-64">
        ...
        />
        <div className="w-full rounded-b-lg absolute bottom-0 left-0 right-0 py-8 px-4 bg-black/60 flex items-center justify-between text-white text-m font-argesta">
